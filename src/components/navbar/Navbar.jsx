  ...
  return (
    <div className="navbar">
      ...
      <div className="navbar-menu">
        {toggleMenu
          ? <RiCloseLine background-color="#000" color="#fff" size={40} onClick={() => setToggleMenu(false)} />
          : <RiMenu3Line background-color="#000" color="#fff" size={40} onClick={() => setToggleMenu(true)} />}
        {toggleMenu && (
